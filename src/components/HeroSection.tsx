      ...
      <div className="container relative z-10 mx-auto grid grid-cols-1 items-center gap-12 md:grid-cols-2">
        <div className="animate-fade-in-left order-last text-center md:order-first md:text-left">
          ...
          <div className="flex flex-col justify-center gap-3 sm:flex-row md:justify-start">
            <Button
              size="lg"
              className="transform rounded-lg bg-gradient-to-r from-primary-600 to-blue-700 px-8 py-6 text-lg font-semibold shadow-md transition-all duration-300 hover:scale-105 hover:from-primary-700 hover:to-blue-800 hover:shadow-lg"
            >
              <a href="#testimonials">Read Review</a>
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="transform rounded-lg border-2 border-primary-400 px-8 py-6 text-lg font-semibold text-primary-600 shadow-md transition-all duration-300 hover:scale-105 hover:border-primary-500 hover:bg-primary-50 hover:shadow-lg"
            >
